export default function Button({ text , type, variant, className, onClick }) {
    ...
    switch (variant) {
        case "primary":
            ...
            break;
        case "secondary":
            selectedVariant = "  px-6 py-2 bg-white/10  backdrop-blur-md border border-white border-opacity-20 rounded-lg shadow-lg text-white hover:bg-opacity-20 transition-all duration-200";
            break;
    }
    return (
        <>
