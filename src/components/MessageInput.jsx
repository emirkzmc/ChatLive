    ...
    return (
        <>
            <form onSubmit={handleSendMessage} className='relative w-full max-w-2xl mx-auto flex flex-row-reverse     '>
                <input type="text" value={message} className='hover:border-[#e6e6e6] transition hover:duration-300 rounded-4xl bg-[#D9D9D9] md:h-10 h-10 w-full border border-[#8C8C8C] pr-6 pl-5'  onChange={(e) => setMessage(e.target.value)}/>
